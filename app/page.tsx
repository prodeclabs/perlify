        ...
        <main className="flex flex-col items-center justify-center space-y-12 sm:space-y-16 text-center">
          ...
          <div className="w-full max-w-md space-y-3 sm:space-y-4 mt-6 sm:mt-8 px-4 sm:px-0">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              ...
              />
              <button className="relative w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-all duration-300 group active:scale-95">
                ...
                <span className="relative z-10 text-white text-sm sm:text-base">Notify Me</span>
              </button>
            </div>
          </div>
